...
1. Built a calibrated live win-probability model over ~1M+ deliveries, achieving Brier 0.17 against a 0.21 logistic baseline, with automated nightly recalibration and shadow-deployed retraining
...
|---|---|---|
| | Live data provider (Cricket Data vs Sportmonks) | |
